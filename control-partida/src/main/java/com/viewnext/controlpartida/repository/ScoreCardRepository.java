...
public interface ScoreCardRepository extends CrudRepository<ScoreCard, Long> {
     ...
     */
    @Query("SELECT SUM(s.score) FROM com.viewnext.controlpartida.domain.ScoreCard s WHERE s.userId = :userId GROUP BY s.userId")
     ...
     */
    @Query("SELECT NEW com.viewnext.controlpartida.domain.LeaderBoardRow(s.userId, SUM(s.score)) " +
            "FROM com.viewnext.controlpartida.domain.ScoreCard s " +

...
public class LeaderBoardControllerTest{
    ...
    public void getLeaderBoardTest() throws Exception{
        // given
        final LeaderBoardRow leaderBoardRow1 = new LeaderBoardRow(1L, 500L);
        final LeaderBoardRow leaderBoardRow2 = new LeaderBoardRow(2L, 400L);
        final List<LeaderBoardRow> leaderBoard = new ArrayList<>();
        ...
        // when
        final MockHttpServletResponse response = mvc.perform(get("/lideres").accept(MediaType.APPLICATION_JSON))
